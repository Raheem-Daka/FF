  ...
  return (
    <>
      <Helmet>
        <title>
          {item?.name
            ? `${item.name} | Footer Furniture`
            : "Product Details | Footer Furniture"}
        </title>
        ...
        <meta
          ...
          content={
            item?.description
              ...
              : "Quality furniture from Footer Furniture."
          }
        />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            offers: {
              ...
              url: `https://footerfurniture.com/product/${item?.id}/${item?.slug}`,
            },
            aggregateRating:
              item?.rating_count > 0
                ? {
        ...
        {`https://footerfurniture.com/product/${id}/${slug}`}
        ...
        <div>
          {isInCart ? (
            ...
            <button
              onClick={addToCart}
              disabled={adding}
              className={`rounded bg-orange-600 text-white px-3 py-2 text-orange-100 min-w-[120px] ${
                adding
